...
HELP_TEXT = (
    ...
    "<code>/ai</code> (ответом на алерт) или <code>/ai &lt;id&gt;</code> — глубокий "
    "AI-анализ: причина и фикс по коду из GitLab\n"
    "<code>/ask &lt;вопрос&gt;</code> — вопрос AI-агенту по ошибкам/пользователям/коду\n"
